...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=gs", "json.web.service.context.path=Replicon"}, service = RepliconService.class)
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface RepliconService extends BaseService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
