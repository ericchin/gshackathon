...
/**
 * Provides the local service interface for Replicon. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RepliconLocalServiceUtil
...
public interface RepliconLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RepliconLocalServiceUtil} to access the replicon local service. Add custom service methods to {@link com.liferay.gs.hackathon.service.impl.RepliconLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Replicon createReplicon(long projectId);
	...
	*/
	...
	public Replicon deleteReplicon(Replicon replicon);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Replicon deleteReplicon(long projectId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Replicon fetchReplicon(long projectId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Replicon fetchRepliconByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Replicon getReplicon(long projectId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Replicon getRepliconByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public Replicon updateReplicon(Replicon replicon);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Replicon> getReplicons(int start, int end);
